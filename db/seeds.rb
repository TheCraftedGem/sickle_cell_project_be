...
# Patient seeds:
Patient.create!(name: 'Test1', street_address: 'Test1 Street', city: 'Denver', state: 'CO', zip_code: 00111, last_visit: DateTime.new(2019, 1, 15, 17))
Patient.create!(name: 'Test2', street_address: 'Test2 Street', city: 'Denver', state: 'CO', zip_code: 00112, last_visit: DateTime.new(2019, 1, 30, 12))
Patient.create!(name: 'Test3', street_address: 'Test3 Street', city: 'Denver', state: 'CO', zip_code: 00113, last_visit: DateTime.new(2019, 2, 28, 11))
